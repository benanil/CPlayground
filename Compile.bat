...
rem Main.c -o MainCLANG.exe -I. -ld3d11 -ldxgi -ldxguid -luser32 -lshell32 -lgdi32 -lwinmm
...
if "%1"=="Debug" (
	...
	cl.exe /Od /Zi /arch:AVX2 /GR- /EHsc- /I. Main.c /Fe:build/MainDebug.exe /link d3d11.lib dxgi.lib dxguid.lib user32.lib shell32.lib gdi32.lib winmm.lib
	if %ERRORLEVEL% neq 0 (
	...
	cl.exe /O2 /arch:AVX2 /GR- /GS- /EHsc- /I. Main.c /Fe:build/MainMSVC.exe /link d3d11.lib dxgi.lib dxguid.lib user32.lib shell32.lib gdi32.lib winmm.lib
	if %ERRORLEVEL% neq 0 (
		echo Compilation failed!
		exit /b %ERRORLEVEL%
	)
